...
import {setPreStudyAnswer, startNewPreStudy} from '../utils/dbUtils';
                ...
                <FormControl error={error8} component="fieldset" className={classes.question}>
                    ...
                    <RadioGroup aria-required onChange={handleRadioChange8} value={value8} row aria-label="gender"
                        ...
                        <FormControlLabel value="I live here"
                                          control={<Checkbox style={{color: '#999999',}} onChange={handleRadioChange8} size='small'/>}
                                          label="I live here"/>
                        ...
                        <FormControlLabel value="Prefer not to say"
                                          ...
                                          label="Prefer not to say"/>
                        <span>
                        <FormControlLabel value="Other" control={<Checkbox style={{color: '#999999',}} onChange={handleRadioChange8} size='small'/>}
                                          label="Other"/>
